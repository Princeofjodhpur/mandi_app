      ...
      onKey: (event) async {
        if ((event.isKeyPressed(LogicalKeyboardKey.controlLeft) ||
          ...
          Navigator.push(context,
              MaterialPageRoute(builder: (context) => PdfViewer(pdfPath: pdf)));
        }
      },
      child: SafeArea(
        child: Scaffold(
              ...
              Padding(
                ...
                child: InkWell(
                  ...
                  onTap: () {
                    vclArray.clear();
                    vclArray.add("All");
                    Future<Map<String, List<SaleModel>>> data =
                        groupTasksByVehicle();
                    data.then((result) {
                  ...
                  itemBuilder: (context, index) {
                    ...
                    for (var element in sale) {
                      if (selected_vcl_no != "" && selectedDate != "") {
                        ...
                        // If Only One is selected from VCL no and Date
                                      ...
                                      children: [
                                        ...
                                        ListView.builder(
                                          ...
                                          itemBuilder: (context, index) {
                                            ...
                                            List<int> filteredItems = task.w
                                                .where((item) => item != 0)
                                                .toList();
                                            String weightString =
                                                filteredItems.join(', ');
                                            return task.farmerName == farmer
                                                ? Column(
                                                    children: [
                                                      Row(
                                                        children: [
          ...
          floatingActionButton: FloatingActionButton(
            ...
            onPressed: () async {
              ...
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => PdfViewer(pdfPath: pdf)));
            },
