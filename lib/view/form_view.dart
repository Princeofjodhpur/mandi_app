...
class _SaleFormViewState extends State<SaleFormView> {
  ...
  Widget buildDynamicRow(String labelPrefix, int count, TextInputType keyboardType) {
    List<FocusNode> focusNodes = List.generate(24, (_) => FocusNode());
